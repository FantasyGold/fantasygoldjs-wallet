...
const _1 = require("./");
const fantasygoldRPC_1 = require("./fantasygoldRPC");
const time_1 = require("./time");
describe("WalletRPCProvider", () => __awaiter(this, void 0, void 0, function* () {
    ...
    before(() => __awaiter(this, void 0, void 0, function* () {
        ...
        yield fantasygoldRPC_1.generateBlock(network);
    ...
    it("invokes sendtocontract method", () => __awaiter(this, void 0, void 0, function* () {
    ...
    it("invokes callcontract method", () => __awaiter(this, void 0, void 0, function* () {
        const data = "6d4ce63c";
