...
const INSIGHT_BASEURLS = {
    [constants_1.NetworkNames.MAINNET]: "https://fantasygold.network/fantasygold-insight-api",
    [constants_1.NetworkNames.TESTNET]: "https://testnet.fantasygold.network/fantasygold-insight-api",
    [constants_1.NetworkNames.REGTEST]: "http://localhost:3001/fantasygold-insight-api", //"http://localhost:3001/insight-api",
};
class Insight {
    constructor(baseURL) {
