...
const INSIGHT_BASEURLS = {
    [constants_1.NetworkNames.MAINNET]: "https://fantasygold.network/fantasygoldinfo-api",
    [constants_1.NetworkNames.TESTNET]: "https://testnet.fantasygold.network/fantasygoldinfo-api",
    [constants_1.NetworkNames.REGTEST]: "http://localhost:3001/fantasygoldinfo-api", //"http://localhost:3001/insight-api",
};
class Insight {
    constructor(baseURL) {
